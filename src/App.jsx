...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://63805fc08efcfcedac03008d.mockapi.io/products')
            const cartData = await axios.get('https://63805fc08efcfcedac03008d.mockapi.io/cart')
            const favoritesData = await axios.get('https://63805fc08efcfcedac03008d.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://63805fc08efcfcedac03008d.mockapi.io/cart/${id}`)
